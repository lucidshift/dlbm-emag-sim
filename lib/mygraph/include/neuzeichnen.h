...
extern void neu_zeichnen_contour3d(Display *myd,mywindow *mw,
				   ...
				   double PSheight, int PSletter, int PSlandscape,
				   grstr *graph);
extern void neu_zeichnen_freedraw(Display *myd,mywindow *mw,int PS,char *psname, double PSwidth, double PSheight, int PSletter, int PSlandscape,
				  grstr *graph);
...
extern void neu_zeichnen_2dgraph(Display *myd,mywindow *mw,
				 ...
				 double PSheight, int PSletter, int PSlandscape,
				 grstr *graph);
extern void neu_zeichnen_3dgraph(Display *myd,mywindow *mw,int PS,char *psname, 
