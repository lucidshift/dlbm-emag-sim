...
typedef struct _grstr {  
  ...
  grdat *dN_R,*dN_Rp,*dN_RxR,*dN_RxRxR,*dN_RxRxRp,*dN_RxRp,*dN_RxRxRxR; /* only some types require these data */
  grvecdat *dNxN_RxR,*dNxN_RxRp;
  Contour ***pcont3d;
  dim1    *dimN_R,*dimN_Rp,*dimN_RxR,*dimN_RxRp,*dimN_RxRxR,*dimN_RxRxRp,*dimN_RxRxRxR;
  dim2    *dimNxN_R,*dimNxN_Rp,*dimNxN_RxR,*dimNxN_RxRp,*dimNxN_RxRxRt;
  dim3    *dimNxNxN_R,*dimNxNxN_Rp,*dimNxNxN_RxRxR,*dimcont3d;
  int **reqN_R,**reqN_Rp,**reqN_RxR,**reqN_RxRp,**reqN_RxRxR,**reqN_RxRxRp,**reqN_RxRxRxR,**reqNxN_R,**reqNxN_Rp,
