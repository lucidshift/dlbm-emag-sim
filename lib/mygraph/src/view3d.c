...
/*	_newframe=0;*/
	...
	if (++gobjektptr<Gobjectnum){ 
	  ...
	  gobjektptr--;
	  printf("Error in view3d.c, too many graphic objects. Increase value in view3d.h : # define Gobjectnum %i",Gobjectnum);
	}
	return r;	
}

void setviewglobal (int xsize, int ysize, double f, double zshift)
{
        double scal;
